    ...
    for l in self.loc: # for all files in data directories
        ...
        for f in files:
            if '.fits' in f:
                ...
                hdu = hdr_temp[self.hdr_ind[l]]  # print the file and correspondin filter
...
def print_objects(self):
    ...
    Input: None
    Return: None
    Prints the values of OBJECT header used for all .fits files in the directories in use.
...
def print_exposures(self):
    ...
    Input:None
    Return: None
    Prints the values of EXPOSURE header used for all .fits files in the directories in use.
    """
    for l in self.loc: # for all files in data directories 
        files = os.listdir(l)
