...
if (whichdate == '190312'):
    location = ["/exports/scratch/MAXIJ1820/190312_fullframes","/exports/scratch/MAXIJ1820/190312_calibs"]
    roi_x = [0.0,1024.0]
    roi_y = [385.0, 490.0]
elif (whichdate == '190317'):
    location = ["/exports/scratch/MAXIJ1820/190317_fullframes","/exports/scratch/MAXIJ1820/190317_calibs"]
    roi_x = [0.0,1024.0]
    roi_y = [460.0, 566.0] 
elif (whichdate == '190318'):
    location = ["/exports/scratch/MAXIJ1820/190318_fullframes","/exports/scratch/MAXIJ1820/190318_calibs"]
    roi_x = [0.0,1024.0]
    roi_y = [420.0, 526.0]
elif (whichdate == '190326'):
    location = ["/exports/scratch/MAXIJ1820/190326_fullframes","/exports/scratch/MAXIJ1820/190326_calibs"]
    roi_x = [45.0,1069.0] # have to shift 45 pix because PESTO moves 45 pix rightward after taking fullframes
    roi_y = [423.0, 523.0]
elif (whichdate == '190404'):
    location = ["/exports/scratch/MAXIJ1820/190404_fullframes","/exports/scratch/MAXIJ1820/190404_calibs"]
    roi_x = [0.0,1024.0]
    roi_y = [415.0, 520.0]

name = "mini_reduced_data" # reduced data directory
target = "/exports/scratch/MAXIJ1820" # location of reduced data directory
type = ["object","calibration"] # types of files being used 
...
reduced_data = data.extract_reduced_images("/exports/scratch/MAXIJ1820/"+name, "reduc")
...
reduced_data.astrometry(roi_x, roi_y, ra_guess, dec_guess, rad_guess, min_scale_guess, max_scale_guess, scale_units)
