...
location = ["/exports/scratch/GRB180618A/grb_pesto_objs",
            "/exports/scratch/GRB180618A/grb_pesto_domeflats"] 
...
reduced_data = data.extract_reduced_images("/exports/scratch/GRB180618A/"+name,
                                           "minired")
